...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-#xq0e!c0qfehim1ge8x5)^yy!z(0n*w)do7b*7-n&7_x3un9vb')
...
# Using Supabase PostgreSQL instead of local SQLite
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'app.authentication.SupabaseJWTAuthentication',
    ),
